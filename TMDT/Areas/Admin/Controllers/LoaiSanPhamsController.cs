...
namespace TMDT.Areas.Admin.Controllers
{
    public class LoaiSanPhamsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "IdLoaiSP,TenLoaiSP")] LoaiSanPham loaiSanPham)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdLoaiSP,TenLoaiSP")] LoaiSanPham loaiSanPham)
        {
            if (ModelState.IsValid)
            {
